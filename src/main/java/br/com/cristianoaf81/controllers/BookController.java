...
public class BookController {
  ...
  @GetMapping(
      produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
  @Operation(summary = "Finds all people", description = "Finds all people", tags = {"Book"},
      responses = {
  ...
  @Operation(summary = "Adds a new book",
      description = "Adds new book by passing a JSON, XML or YML  representation of book!",
      tags = {"Book"},
      responses = {
          @ApiResponse(description = "Success", responseCode = "200",
              content = {@Content(mediaType = "application/json",
  ...
  @DeleteMapping(value = "/{id}")
      @Operation(summary = "Deletes a book", description = "Updates a book by passing an book id", tags = {"Book"},
      responses = {
