...
public class PersonController {
  ...
  @Operation(summary = "Adds a new person",
      description = "Adds new Person by passing a JSON, XML or YML  representation of Person!",
      tags = {"People"},
      responses = {
          @ApiResponse(description = "Success", responseCode = "200",
              content = {@Content(mediaType = "application/json",
  ...
  @DeleteMapping(value = "/{id}")
      @Operation(summary = "Deletes a person", description = "Updates a person by passing an person id", tags = {"People"},
      responses = {
